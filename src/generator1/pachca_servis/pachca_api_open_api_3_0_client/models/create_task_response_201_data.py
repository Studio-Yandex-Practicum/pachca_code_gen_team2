...
if TYPE_CHECKING:
    from ..models.create_task_response_201_data_custom_properties_item import (
...
@_attrs_define
class CreateTaskResponse201Data:
    """
    Attributes:
        ...
        custom_properties (Union[Unset, list['CreateTaskResponse201DataCustomPropertiesItem']]):
    """
    ...
    custom_properties: Union[Unset, list["CreateTaskResponse201DataCustomPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for custom_properties_item_data in _custom_properties or []:
            custom_properties_item = CreateTaskResponse201DataCustomPropertiesItem.from_dict(
                custom_properties_item_data
            )

            custom_properties.append(custom_properties_item)

        create_task_response_201_data = cls(
            id=id,
            kind=kind,
            content=content,
            due_at=due_at,
        ...
        create_task_response_201_data.additional_properties = d
        return create_task_response_201_data
