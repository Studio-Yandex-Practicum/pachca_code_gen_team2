...
if TYPE_CHECKING:
    from ..models.create_task_body_task_custom_properties_item import CreateTaskBodyTaskCustomPropertiesItem


T = TypeVar("T", bound="CreateTaskBodyTask")


@_attrs_define
class CreateTaskBodyTask:
    """
    Attributes:
        ...
        custom_properties (Union[Unset, list['CreateTaskBodyTaskCustomPropertiesItem']]):
    """
    ...
    custom_properties: Union[Unset, list["CreateTaskBodyTaskCustomPropertiesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for custom_properties_item_data in _custom_properties or []:
            custom_properties_item = CreateTaskBodyTaskCustomPropertiesItem.from_dict(custom_properties_item_data)

            custom_properties.append(custom_properties_item)

        create_task_body_task = cls(
            kind=kind,
            content=content,
            due_at=due_at,
            priority=priority,
        ...
        create_task_body_task.additional_properties = d
        return create_task_body_task
