...
class Forwarding(BaseModel):
    ...
    original_thread_message_id: Optional[int] = Field(
        None,
    ...
    original_thread_parent_chat_id: Optional[int] = Field(
        None,
...
class ResponseCreatemessagePost201(BaseModel):
