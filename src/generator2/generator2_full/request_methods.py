...
class RequestMethods:
    ...
    async def get_uploads(self) -> ResponseGetuploadsPost200:
        ...
        async with client:
            ...
            if response.is_success:
                return ResponseGetuploadsPost200.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def get_employee(self, id: int) -> ResponseGetemployeeGet200:
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/users/{id}", {"id": id})
            response = await client.get(url)
            if response.is_success:
                return ResponseGetemployeeGet200.model_validate_json(
                    response.text,
                )
            if response.is_client_error:
                return ResponseGetemployeeGet400.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def get_status(self) -> ResponseGetstatusGet200:
        ...
        async with client:
            ...
            response = await client.get(url)
            if response.is_success:
                return ResponseGetstatusGet200.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def put_status(self, data: Putstatus) -> ResponsePutstatusPut201:
        ...
        async with client:
            ...
            if response.is_success:
                return ResponsePutstatusPut201.model_validate_json(
                    response.text,
                )
            if response.is_client_error:
                return ResponsePutstatusPut400.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def get_tag(self, id: int) -> ResponseGettagGet200:
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/group_tags/{id}", {"id": id})
            response = await client.get(url)
            if response.is_success:
    ...
    async def get_tags(
        ...
        async with client:
            url = "/group_tags"
            query_params = await self.filter_query_params(per=per, page=page)
            response = await client.get(url, params=query_params)
            if response.is_success:
    ...
    async def get_tags_employees(
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/group_tags/{id}/users", {"id": id})
            query_params = await self.filter_query_params(per=per, page=page)
            response = await client.get(url, params=query_params)
            if response.is_success:
    ...
    async def get_chats(
        ...
        async with client:
            ...
            response = await client.get(url, params=query_params)
            if response.is_success:
                return ResponseGetchatsGet200.model_validate_json(
                    response.text,
                )
            if response.is_client_error:
                return ResponseGetchatsGet422.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def create_chat(self, data: Createchat) -> ResponseCreatechatPost201:
        ...
        async with client:
            ...
            response = await client.post(url, json=data.model_dump())
            if response.is_success:
                return ResponseCreatechatPost201.model_validate_json(
                    response.text,
                )
            if response.is_client_error:
                return ResponseCreatechatPost422.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def get_chat(self, id: int) -> ResponseGetchatGet200:
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/chats/{id}", {"id": id})
            response = await client.get(url)
            if response.is_success:
    ...
    async def post_members_to_chats(self, data: Postmemberstochats, id: int):
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/chats/{id}/members", {"id": id})
            response = await client.post(url, json=data.model_dump())
            if response.is_client_error:
    ...
    async def post_tags_to_chats(self, data: Posttagstochats, id: int):
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/chats/{id}/group_tags", {"id": id})
            response = await client.post(url, json=data.model_dump())
            if response.is_client_error:
    ...
    async def leave_chat(self, id: int):
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/chats/{id}/leave", {"id": id})
            response = await client.delete(url)
            if response.is_client_error:
    ...
    async def create_thread(self, id: int) -> ResponseCreatethreadPost200:
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/messages/{id}/thread", {"id": id})
            response = await client.post(url)
            if response.is_success:
    ...
    async def get_message(self, id: int) -> ResponseGetmessageGet200:
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/messages/{id}", {"id": id})
            response = await client.get(url)
            if response.is_success:
                return ResponseGetmessageGet200.model_validate_json(
                    response.text,
                )
            if response.is_client_error:
                return ResponseGetmessageGet400.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def edit_message(
        ...
        async with client:
            ...
            response = await client.put(url, json=data.model_dump())
            if response.is_success:
                return ResponseEditmessagePut200.model_validate_json(
                    response.text,
                )
            if response.is_client_error:
                return ResponseEditmessagePut400.model_validate_json(
                    response.text,
                )
            return None
    ...
    async def get_message_reactions(
        ...
        client = await self.get_client()
        async with client:
            url = await self.format_url("/messages/{id}/reactions", {"id": id})
            query_params = await self.filter_query_params(per=per, page=page)
            response = await client.get(url, params=query_params)
            if response.is_success:
    ...
    async def post_message_reactions(
        self, data: Postmessagereactions, id: int,
    ):
        """добавление реакции
    ...
    async def delete_message_reactions(self, id: int, code: str = None):
        ...
        async with client:
            url = await self.format_url("/messages/{id}/reactions", {"id": id})
            query_params = await self.filter_query_params(code=code)
    ...
    async def create_task(self, data: Createtask) -> ResponseCreatetaskPost201:
        ...
        async with client:
            ...
            response = await client.post(url, json=data.model_dump())
            if response.is_success:
                return ResponseCreatetaskPost201.model_validate_json(
                    response.text,
                )
            if response.is_client_error:
                return ResponseCreatetaskPost400.model_validate_json(
                    response.text,
                )
            return None
