...
class Data(BaseModel):
    ...
    id: Optional[int] = Field(None, description='Идентификатор созданного напоминания')
    user_id: Optional[int] = Field(None, description='Идентификатор пользователя-создателя')
    status: Optional[str] = Field(None, description='Статус напоминания')
    created_at: Optional[str] = Field(None, description='Дата и время создания')
