...
class Files(BaseModel):
    ...
    size: int = Field(..., description='Размер файла в байтах, отображаемый пользователю')
...
class Message(BaseModel):
    ...
    skip_invite_mentions: Optional[bool] = Field(None, description='No docstring provided')
    link_preview: Optional[bool] = Field(None, description='No docstring provided')


class Createmessage(BaseModel):
    message: Optional[Message] = Field(None, description='No docstring provided')
