from .models.models_response_getCommonMethodsget200 import ResponseGetcommonmethodsGet200
from .models.models_response_getCommonMethodsget400 import ResponseGetcommonmethodsGet400
...
from .models.models_response_getEmployeesget200 import ResponseGetemployeesGet200
...
from .models.models_response_getTagsEmployeesget200 import ResponseGettagsemployeesGet200
from .models.models_response_getTagsEmployeesget400 import ResponseGettagsemployeesGet400
...
from .models.models_response_postMembersToChatspost400 import ResponsePostmemberstochatsPost400
from .models.models_response_postMembersToChatspost422 import ResponsePostmemberstochatsPost422
from .models.models_reqBod_postTagsToChats import Posttagstochats
from .models.models_response_postTagsToChatspost400 import ResponsePosttagstochatsPost400
from .models.models_response_postTagsToChatspost422 import ResponsePosttagstochatsPost422
from .models.models_response_leaveChatdelete400 import ResponseLeavechatDelete400
from .models.models_response_createThreadpost200 import ResponseCreatethreadPost200
from .models.models_response_createThreadpost400 import ResponseCreatethreadPost400
from .models.models_response_getListMessageget200 import ResponseGetlistmessageGet200
from .models.models_response_getListMessageget400 import ResponseGetlistmessageGet400
from .models.models_reqBod_createMessage import Createmessage
from .models.models_response_createMessagepost201 import ResponseCreatemessagePost201
from .models.models_response_createMessagepost400 import ResponseCreatemessagePost400
...
from .models.models_response_getMessageReactionsget200 import ResponseGetmessagereactionsGet200
from .models.models_response_getMessageReactionsget400 import ResponseGetmessagereactionsGet400
from .models.models_reqBod_postMessageReactions import Postmessagereactions
from .models.models_response_postMessageReactionspost400 import ResponsePostmessagereactionsPost400
from .models.models_response_deleteMessageReactionsdelete400 import ResponseDeletemessagereactionsDelete400
...
async def get_common_methods(self, entity_type: str = None) -> ResponseGetcommonmethodsGet200:
...
URL (например, /custom_properties?entity_type=User)"""
    ...
    async with client:
        ...
        if response.is_success:
            return ResponseGetcommonmethodsGet200.model_validate_json(response.text)
        if response.is_client_error:
            return ResponseGetcommonmethodsGet400.model_validate_json(response.text)
        return None
...
async def get_employees(self, per: int = None, page: int = None, query: str = None) -> ResponseGetemployeesGet200:
...
/users?per=50&page=2&query=example.com)"""
    ...
    async with client:
        url = '/users'
        query_params=self.filter_query_params(per=per, page=page, query=query)
        response = await client.get(url, params=query_params)
        if response.is_success:
            return ResponseGetemployeesGet200.model_validate_json(response.text)
        return None
...
async def get_tags(self, per: int = None, page: int = None) -> ResponseGettagsGet200:
...
async def get_tags_employees(self, id: int, per: int = None, page: int = None) -> ResponseGettagsemployeesGet200:
...
в URL (например, /group_tags/877650/users?per=3&page=2)"""
    ...
    async with client:
        ...
        response = await client.get(url, params=query_params)
        if response.is_success:
            return ResponseGettagsemployeesGet200.model_validate_json(response.text)
        if response.is_client_error:
            return ResponseGettagsemployeesGet400.model_validate_json(response.text)
        return None


async def get_chats(self, sort_field: str = 'id', sort: str = 'desc', per: int = None, page: int = None, availability: str = None, last_message_at_after: str = None, last_message_at_before: str = None) -> ResponseGetchatsGet200:
...
/chats?per=2&sort[id]=desc)"""
    ...
    async with client:
        url = '/chats'
        query_params=self.filter_query_params(sort_field=sort_field, sort=sort, per=per, page=page, availability=availability, last_message_at_after=last_message_at_after, last_message_at_before=last_message_at_before)
        response = await client.get(url, params=query_params)
        if response.is_success:
...
Метод для добавления пользователей в состав участников беседы или канала."""
    ...
    async with client:
        ...
        response = await client.post(url, json=data.model_dump())
        if response.is_client_error:
            return ResponsePostmemberstochatsPost422.model_validate_json(response.text)
        return None
...
Метод для добавления тегов в состав участников беседы или канала."""
    ...
    async with client:
        ...
        response = await client.post(url, json=data.model_dump())
        if response.is_client_error:
            return ResponsePosttagstochatsPost422.model_validate_json(response.text)
        return None
...
отсутствуют/"""
    ...
    async with client:
        ...
        response = await client.delete(url)
        if response.is_client_error:
            return ResponseLeavechatDelete400.model_validate_json(response.text)
        return None
...
тред, то в ответе вернётся информация об уже созданном ранее треде."""
    ...
    async with client:
        ...
        response = await client.post(url)
        if response.is_success:
            return ResponseCreatethreadPost200.model_validate_json(response.text)
        if response.is_client_error:
            return ResponseCreatethreadPost400.model_validate_json(response.text)
        return None


async def get_list_message(self, chat_id: int = None, per: int = None, page: int = None) -> ResponseGetlistmessageGet200:
...
/messages?chat_id=198&per=3)"""
    ...
    async with client:
        url = '/messages'
        query_params=self.filter_query_params(chat_id=chat_id, per=per, page=page)
        response = await client.get(url, params=query_params)
        if response.is_success:
            return ResponseGetlistmessageGet200.model_validate_json(response.text)
        if response.is_client_error:
            return ResponseGetlistmessageGet400.model_validate_json(response.text)
        return None


async def create_message(self, data: Createmessage) -> ResponseCreatemessagePost201:
...
пользователями может быть только один личный чат."""
    ...
    async with client:
        ...
        response = await client.post(url, json=data.model_dump())
        if response.is_success:
            return ResponseCreatemessagePost201.model_validate_json(response.text)
        if response.is_client_error:
            return ResponseCreatemessagePost400.model_validate_json(response.text)
        return None
...
async def edit_message(self, data: Editmessage, id: int) -> ResponseEditmessagePut200:
...
async def get_message_reactions(self, id: int, per: int = None, page: int = None) -> ResponseGetmessagereactionsGet200:
...
страница выборки указываются в теле запроса"""
    ...
    async with client:
        ...
        response = await client.get(url, params=query_params)
        if response.is_success:
            return ResponseGetmessagereactionsGet200.model_validate_json(response.text)
        if response.is_client_error:
            return ResponseGetmessagereactionsGet400.model_validate_json(response.text)
        return None
...
не более 1000 реакций."""
    ...
    async with client:
        ...
        response = await client.post(url, json=data.model_dump())
        if response.is_client_error:
            return ResponsePostmessagereactionsPost400.model_validate_json(response.text)
        return None
...
которые были поставлены авторизованным пользователем."""
    ...
    async with client:
        ...
        if response.is_client_error:
            return ResponseDeletemessagereactionsDelete400.model_validate_json(response.text)
        return None
