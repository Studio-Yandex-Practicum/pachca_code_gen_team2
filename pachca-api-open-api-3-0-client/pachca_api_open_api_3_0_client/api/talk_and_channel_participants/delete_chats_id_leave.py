...
def _build_response_delete_chats_id_leave(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    return Response(
        ...
        parsed=_parse_response_delete_chats_id_leave(client=client, response=response),
    )
...
async def asyncio_detailed_delete_chats_id_leave(
    ...
    *,
    ...
    kwargs = _get_kwargs_delete_chats_id_leave(
        id=id,
    )
...
async def delete_chats_id_leave(
    ...
    *,
    ...
    return (
        await asyncio_detailed_delete_chats_id_leave(
            id=id,
            client=client,
        )
    ).parsed
