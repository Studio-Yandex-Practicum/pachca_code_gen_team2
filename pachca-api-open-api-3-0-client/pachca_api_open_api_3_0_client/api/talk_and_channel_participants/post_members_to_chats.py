...
def _build_response_postMembersToChats(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    return Response(
        ...
        parsed=_parse_response_postMembersToChats(client=client, response=response),
    )
...
async def asyncio_detailed_postMembersToChats(
    ...
    *,
    ...
    kwargs = _get_kwargs_postMembersToChats(
        id=id,
        body=body,
    )
...
async def postMembersToChats(
    ...
    *,
    ...
    return (
        await asyncio_detailed_postMembersToChats(
            id=id,
            client=client,
            body=body,
        )
