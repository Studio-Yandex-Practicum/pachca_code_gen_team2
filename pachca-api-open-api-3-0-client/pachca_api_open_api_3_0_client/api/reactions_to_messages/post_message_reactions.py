...
def _build_response_postMessageReactions(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    return Response(
        ...
        parsed=_parse_response_postMessageReactions(client=client, response=response),
    )
...
async def asyncio_detailed_postMessageReactions(
    ...
    *,
    ...
    kwargs = _get_kwargs_postMessageReactions(
        id=id,
        body=body,
    )
...
async def postMessageReactions(
    ...
    *,
    ...
    return (
        await asyncio_detailed_postMessageReactions(
            id=id,
            client=client,
            body=body,
        )
